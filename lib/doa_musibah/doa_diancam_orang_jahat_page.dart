...
class DoaDiancamOrangJahatPage extends StatelessWidget {
  const DoaDiancamOrangJahatPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Doa Ketika Diancam Orang Jahat",
          style: TextStyle(
            color: mainTextColor,
            fontSize: 16,
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "اَللَّهُمَّ اكْفِنِيْهِمْ بِمَا شِئْتَ",
