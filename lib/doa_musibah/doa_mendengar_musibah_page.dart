...
class DoaMendengarMusibahPage extends StatelessWidget {
  const DoaMendengarMusibahPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Inna lillaahi wa innaa ilaihi raaji'uun. Allahumma-jurnii fii mushiibatii wa akhlif lii khairan minhaa.",
              style: TextStyle(
                color: subTextColor,
                fontSize: 14,
