...
class DoaSaatSusahPage extends StatelessWidget {
  const DoaSaatSusahPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Ya Allah, tidak ada kemudahan kecuali apa yang Engkau jadikan mudah. Dan Engkau dapat menjadikan kesedihan/kesulitan itu menjadi mudah apabila Engkau menghendaki.",
          ...
          Container(
            ...
            child: Text(
              "Dibaca saat menghadapi ujian berat, kebuntuan hidup, atau situasi sulit agar dianugerahi kemudahan berpikir, kekuatan fisik, serta penyelesaian terbaik.",
              style: TextStyle(
