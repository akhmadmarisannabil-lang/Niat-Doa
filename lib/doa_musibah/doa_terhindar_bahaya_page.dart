...
class DoaTerhindarBahayaPage extends StatelessWidget {
  const DoaTerhindarBahayaPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              "Dianjurkan dibaca sebanyak 3 kali pada pagi hari dan 3 kali pada petang hari. Keutamaannya menurut hadis riwayat Abu Dawud dan Tirmidzi adalah penjagaan mutlak sehingga tidak ada bahaya atau musibah mendadak yang dapat mencelakai pembacanya.",
              style: TextStyle(
