...
class DoaMenolakFirasatBurukPage extends StatelessWidget {
  const DoaMenolakFirasatBurukPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Ya Allah, tidak ada kesialan kecuali kesialan yang Engkau takdirkan, dan tidak ada kebaikan kecuali kebaikan-Mu, serta tidak ada sesembahan yang berhak disembah selain Engkau.",
