...
class DoaHusnulKhotimahPage extends StatelessWidget {
  const DoaHusnulKhotimahPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              "Allahummaj'al khaira 'umrii aakhirahu, wa khaira 'amalii khawaatimahu, wa khaira ayyaamii yauma alqaaka fiihi.",
              style: TextStyle(
