...
class RukuPage extends StatelessWidget {
  const RukuPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Subhaana rabbiyal-'adzhiimi wa bihamdihi. (Dibaca 3x)",
              style: TextStyle(
                color: subTextColor,
                fontSize: 14,
          ...
          Container(
            ...
            child: Text(
              "Doa ruku' dibaca secara tuma'ninah ketika posisi tubuh membungkuk datar 90 derajat sembari memegang kedua lutut menggunakan telapak tangan. Dianjurkan dibaca sebanyak 3 kali.",
              style: TextStyle(
