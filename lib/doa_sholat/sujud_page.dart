...
class SujudPage extends StatelessWidget {
  const SujudPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Subhaana rabbiyal-a'laa wa bihamdihi. (Dibaca 3x)",
              style: TextStyle(
                color: subTextColor,
                fontSize: 14,
          ...
          Container(
            ...
            child: Text(
              "Doa sujud dibaca saat posisi sujud sempurna, yaitu ketika dahi, hidung, kedua telapak tangan, kedua lutut, dan ujung-ujung jari kaki menempel rapat di lantai. Dibaca tenang sebanyak 3 kali.",
              style: TextStyle(
