...
class KeluarRumahPage extends StatelessWidget {
  const KeluarRumahPage({super.key});
        ...
        children: [
          Wrap(
            ...
            children: [
              ...
              _buildTag("keluar rumah", chipBgColor, chipTextColor),
              _buildTag("tawakal", chipBgColor, chipTextColor),
            ],
          ),
          ...
          Container(
            ...
            child: Text(
              "Dibaca ketika hendak melangkah keluar meninggalkan pintu rumah untuk memulai aktivitas. Keutamaan doa ini adalah diberikannya kecukupan, perlindungan dari marabahaya, serta petunjuk selama perjalanan.",
              style: TextStyle(
