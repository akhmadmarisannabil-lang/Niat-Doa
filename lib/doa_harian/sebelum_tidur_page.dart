...
class SebelumTidurPage extends StatelessWidget {
  const SebelumTidurPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Dibaca saat sudah berbaring di tempat tidur dan siap untuk beristirahat. Berfungsi sebagai penyerahan diri secara penuh kepada Allah sebelum memasuki kondisi tidur yang menyerupai kematian kecil.",
              style: TextStyle(
