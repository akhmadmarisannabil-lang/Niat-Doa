...
class MasukKamarMandiPage extends StatelessWidget {
  const MasukKamarMandiPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Dibaca sebelum melangkahkan kaki ke dalam kamar mandi, disunnahkan masuk menggunakan kaki kiri terlebih dahulu.",
              style: TextStyle(
