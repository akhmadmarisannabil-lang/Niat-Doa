...
class TakutTidurPage extends StatelessWidget {
  const TakutTidurPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Aku berlindung dengan kalimat-kalimat Allah yang sempurna dari kemurkaan-Nya, siksaan-Nya, kejahatan hamba-hamba-Nya, dan dari godaan setan-setan serta kehadiran mereka kepadaku.",
