...
class SesudahMakanPage extends StatelessWidget {
  const SesudahMakanPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Dibaca sesudah selesai makan dan minum. Mengandung makna pengakuan bahwa kekuatan dan kenyang yang kita peroleh semata-mata adalah karunia dan nikmat dari Allah SWT.",
              style: TextStyle(
