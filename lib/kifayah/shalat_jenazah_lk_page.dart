...
class ShalatJenazahLkPage extends StatefulWidget {
  const ShalatJenazahLkPage({super.key});

  @override
  State<ShalatJenazahLkPage> createState() => _ShalatJenazahLkPageState();
}

class _ShalatJenazahLkPageState extends State<ShalatJenazahLkPage> {
  ...
  final Map<String, Map<String, String>> _niatData = {
    'Shalat Jenazah Sendirian': {
      ...
      'arabic':
          "أُصَلِّى عَلَى هٰذَا الْمَيِّتِ أَرْبَعَ تَكْبِيْرَاتٍ فَرْضَ كِفَايَةٍ لِلّٰهِ تَعَالَىٰ",
      'transliteration':
          "Ushallii 'alaa haadzal mayyiti arba'a takbiiraatin fardha kifaayatin lillaahi ta'aalaa.",
      'translation':
    ...
    'Shalat Jenazah Sebagai Imam': {
      'title': 'Niat (Imam)',
      'arabic':
          "أُصَلِّى عَلَى هٰذَا الْمَيِّتِ أَرْبَعَ تَكْبِيْرَاتٍ فَرْضَ كِفَايَةٍ اِمَامًا لِلّٰهِ تَعَالَىٰ",
      'transliteration':
          "Ushallii 'alaa haadzal mayyiti arba'a takbiiraatin fardha kifaayatin imaaman lillaahi ta'aalaa.",
      'translation':
          "Aku berniat shalat atas jenazah ini empat takbir fardhu kifayah sebagai imam karena Allah Ta'ala.",
    },
    'Shalat Jenazah Sebagai Makmum': {
      'title': 'Niat (Makmum)',
      'arabic':
          "أُصَلِّى عَلَى هٰذَا الْمَيِّتِ أَرْبَعَ تَكْبِيْرَاتٍ فَرْضَ كِفَايَةٍ مَأْمُوْمًا لِلّٰهِ تَعَالَىٰ",
      'transliteration':
          "Ushallii 'alaa haadzal mayyiti arba'a takbiiraatin fardha kifaayatin ma'muuman lillaahi ta'aalaa.",
      'translation':
          "Aku berniat shalat atas jenazah ini empat takbir fardhu kifayah sebagai makmum karena Allah Ta'ala.",
    },
  };
  ...
  final List<Map<String, dynamic>> _tataCaraUrutanData = [
    {
      ...
      'desc':
          'Shalat jenazah dilakukan dengan berdiri tegak tanpa rukuk dan sujud. Berniat di dalam hati bersamaan dengan mengangkat tangan saat takbiratul ihram membaca:',
      'hasRead': true,
    ...
    },
    {
      ...
      'desc':
          'Setelah takbir kedua selesai, dilanjutkan dengan membaca shalawat kepada Nabi Muhammad SAW (minimal shalawat pendek, disunnahkan shalawat Ibrahimiyah lengkap):',
      'hasRead': true,
      'arabic':
    ...
    {
      'header': 'Langkah 6',
      'title': 'Membaca Doa untuk Jenazah Laki-laki',
      'desc':
          'Setelah takbir ketiga selesai, bacalah doa khusus permohonan ampunan untuk jenazah laki-laki (menggunakan dhomir tunggal pria "-hu"):',
      'hasRead': true,
      ...
      'arti':
          "Ya Allah, ampunilah dia, berilah rahmat kepadanya, selamatkanlah dia, dan maafkanlah kesalahannya.",
    },
    {
      'header': 'Langkah 7',
    ...
    {
      'header': 'Langkah 8',
      'title': 'Membaca Doa Penutup Jenazah',
      'desc':
          'Selesai takbir keempat, disunnahkan membaca doa keselamatan bagi keluarga dan orang hidup yang ditinggalkan sebelum melakukan gerakan salam:',
      'hasRead': true,
      'arabic':
