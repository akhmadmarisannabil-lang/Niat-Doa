...
class RapatKerjaPage extends StatelessWidget {
  const RapatKerjaPage({super.key});
        ...
        children: [
          Wrap(
            ...
            children: [
              ...
              _buildTag("musyawarah", chipBgColor, chipTextColor),
              _buildTag("maslahat", chipBgColor, chipTextColor),
            ],
          ),
          ...
          Container(
            ...
            child: Text(
              "Berasal dari QS. Al-Kahfi ayat 10. Cocok dibaca di awal rapat organisasi maupun korporasi agar segala keputusan yang diambil dipimpin oleh kelurusan.",
              style: TextStyle(
