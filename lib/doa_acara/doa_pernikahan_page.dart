        ...
        children: [
          Wrap(
            ...
            children: [
              ...
              _buildTag("pernikahan", chipBgColor, chipTextColor),
              _buildTag("barakah", chipBgColor, chipTextColor),
            ],
          ),
          ...
          Container(
            ...
            child: Text(
              "Merupakan ucapan selamat dan doa resmi pernikahan dari tuntunan Rasulullah ﷺ (HR. Abu Dawud). Doa ini unik karena memohon berkah bagi kedua mempelai tidak hanya saat senang, tapi juga kelak saat mengarungi ujian rumah tangga.",
              style: TextStyle(
