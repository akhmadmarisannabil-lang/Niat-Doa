  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          "Doa Pelepasan Musafir",
          style: TextStyle(
            color: Colors.white,
            fontSize: 18, // Disamakan menjadi 18
      ...
      body: ListView(
        ...
        children: [
          Wrap(
            ...
            children: [
              _buildTag("Safar"),
              _buildTag("Perjalanan"),
              _buildTag("Titip Amanah"),
            ],
          ),
          ...
          const Text(
            "Transliterasi",
            style: TextStyle(
              color: Colors.tealAccent, // Memperbaiki warna gelap sebelumnya
              fontWeight: FontWeight.bold,
              fontSize: 14,
            ),
          ),
