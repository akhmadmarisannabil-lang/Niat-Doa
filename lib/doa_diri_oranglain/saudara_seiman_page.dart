...
class SaudaraSeimanPage extends StatelessWidget {
  const SaudaraSeimanPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Robbanaa ghfir lanaa wa li-ikhwaaninal ladziina sabaquunaa bil iimaan.",
              style: TextStyle(
                color: subTextColor,
                fontSize: 14,
