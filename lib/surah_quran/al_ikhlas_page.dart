...
class AlIkhlasPage extends StatefulWidget {
  ...
  const AlIkhlasPage({super.key, required this.surahData});
...
class _AlIkhlasPageState extends State<AlIkhlasPage> {
  ...
  final List<GlobalKey> ayatKeys = List.generate(4, (_) => GlobalKey());
  ...
  Future<void> loadAudioData() async {
    final data = await QuranApiService.getSurat(112);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.surahData['name'] ?? 'Al-Ikhlas',
          style: TextStyle(
            color: mainTextColor,
            fontSize: 16,
