...
class AlAlaqPage extends StatefulWidget {
  final Map<String, dynamic> surahData;

  const AlAlaqPage({super.key, required this.surahData});

  @override
  State<AlAlaqPage> createState() => _AlAlaqPageState();
}

class _AlAlaqPageState extends State<AlAlaqPage> {
  ...
  Future<void> loadAudioData() async {
    final data = await QuranApiService.getSurat(96);
