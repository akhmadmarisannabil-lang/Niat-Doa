...
class AnNasPageState extends State<AnNasPage> {
  ...
  Future<void> loadAudioData() async {
    final data = await QuranApiService.getSurat(114);
        ...
        children: [
          Wrap(
            ...
            children: [
              ...
              _buildChip(
                "${widget.surahData['verses'] ?? 6} Ayat",
                chipBgColor,
                chipTextColor,
              ),
