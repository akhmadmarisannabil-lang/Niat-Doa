...
class AlFalaqPage extends StatefulWidget {
  ...
  const AlFalaqPage({super.key, required this.surahData});

  @override
  State<AlFalaqPage> createState() => AlFalaqPageState();
}

class AlFalaqPageState extends State<AlFalaqPage> {
  final AudioPlayer player = AudioPlayer();

  final ScrollController _scrollController = ScrollController();
  final List<GlobalKey> ayatKeys = List.generate(5, (_) => GlobalKey());
  ...
  Future<void> loadAudioData() async {
    final data = await QuranApiService.getSurat(113);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.surahData['name'] ?? 'Al-Falaq',
          style: TextStyle(
            color: mainTextColor,
            fontSize: 16,
