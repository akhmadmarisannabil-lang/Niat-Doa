...
class AlFalaqPage extends StatelessWidget {
    ...
    final List<Map<String, dynamic>> ayatList = [
      {
        ...
        'translation':
            "Katakanlah (Nabi Muhammad), “Aku berlindung kepada Tuhan yang menguasai fajar (subuh)",
      },
      {
        'no': '2',
      ...
      {
        'no': '4',
        'arabic': "وَمِنْ شَرِّ النَّفّٰثٰتِ فِي الْعُقَدِۙ",
      ...
      {
        'no': '5',
        'arabic': "وَمِنْ شَرِّ حَاسِدٍ اِذَا حَسَدَࣖ",
