...
class AsySyarhPage extends StatefulWidget {
  final Map<String, dynamic> surahData;

  const AsySyarhPage({super.key, required this.surahData});

  @override
  State<AsySyarhPage> createState() => _AsySyarhPageState();
}
...
class _AsySyarhPageState extends State<AsySyarhPage> {
  ...
  Future<void> loadAudioData() async {
    final data = await QuranApiService.getSurat(94);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          widget.surahData['name'] ?? 'Asy-Syarh',
          style: TextStyle(
            color: mainTextColor,
            fontSize: 16,
