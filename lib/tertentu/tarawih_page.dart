...
class TarawihPage extends StatefulWidget {
  const TarawihPage({super.key});

  @override
  State<TarawihPage> createState() => _TarawihPageState();
}

class _TarawihPageState extends State<TarawihPage> {
  // Menggunakan satu dropdown menu tunggal yang digabung
  String _selectedOption = 'Shalat Tarawih Sendirian';

  final List<String> _dropdownOptions = [
    'Shalat Tarawih Sendirian',
    'Shalat Tarawih Sebagai Imam',
    'Shalat Tarawih Sebagai Makmum',
  ...
  final Map<String, Map<String, String>> _niatData = {
    'Shalat Tarawih Sendirian': {
      ...
      'arabic':
          "أُصَلِّى سُنَّةَ التَّرَاوِيْحِ رَكْعَتَيْنِ لِلّٰهِ تَعَالَىٰ",
      'transliteration':
          "Ushallii sunnatat-taraawiihi rak'ataini lillaahi ta'aalaa.",
      'translation':
          "Aku berniat shalat sunnah Tarawih dua rakaat karena Allah Ta'ala.",
    },
    'Shalat Tarawih Sebagai Imam': {
      'title': 'Niat (Imam)',
      'arabic':
          "أُصَلِّى سُنَّةَ التَّرَاوِيْحِ رَكْعَتَيْنِ إِمَامًا لِلّٰهِ تَعَالَىٰ",
      'transliteration':
          "Ushallii sunnatat-taraawiihi rak'ataini imaaman lillaahi ta'aalaa.",
      'translation':
          "Aku berniat shalat sunnah Tarawih dua rakaat sebagai imam karena Allah Ta'ala.",
    },
    'Shalat Tarawih Sebagai Makmum': {
      'title': 'Niat (Makmum)',
      'arabic':
          "أُصَلِّىْ سُنَّةَ التَّرَاوِيْحِ رَكْعَتَيْنِ مَأْمُوْمًا لِلّٰهِ تَعَالَىٰ",
      'transliteration':
          "Ushallii sunnatat-taraawiihi rak'ataini ma'muuman lillaahi ta'aalaa.",
      'translation':
          "Aku berniat shalat sunnah Tarawih dua rakaat sebagai makmum karena Allah Ta'ala.",
    },
  };
  ...
  final List<Map<String, dynamic>> _tataCaraData = [
    {
      ...
      'desc':
          'Memantapkan niat di dalam hati sesuai opsi peran yang dipilih (sendirian/imam/makmum) sebelum mengangkat tangan takbir.',
      'hasRead': false,
    },
    {
      'header': 'Langkah 2',
      ...
      'desc':
          'Mengangkat kedua tangan sejajar telinga (bagi laki-laki) atau dada (bagi perempuan) seraya mengucap takbir:',
      'hasRead': true,
    ...
    },
    {
      ...
      'desc': 'Disunnahkan membaca Surat Al-Qur\'an',
      'hasRead': false,
    },
    {
    ...
    },
    {
      ...
      'desc':
          'Bangkit berdiri tegak untuk memulai rakaat kedua, kemudian mengulangi gerakan membaca Al-Fatihah dan Surat Pendek, dilanjutkan Rukuk, I\'tidal, Sujud, Duduk, Dan sujud kembali',
      'hasRead': false,
    },
    {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isTataCara = _selectedOption == 'Tata Cara Shalat Tarawih';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          isTataCara ? "Tata Cara Shalat Tarawih" : "Niat Shalat Tarawih",
          style: TextStyle(
            color: mainTextColor,
            fontSize: 16,
          ...
          if (!isTataCara) ...[
            ...
            Row(
              children: [
                ...
                Text(
                  "Panduan Siklus Shalat Tarawih (2 Rakaat)",
                  style: TextStyle(
                    color: accentColor,
                    fontWeight: FontWeight.bold,
                    fontSize: 15,
