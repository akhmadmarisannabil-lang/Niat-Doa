...
class BerbukaPuasaPage extends StatelessWidget {
  const BerbukaPuasaPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Ungkapan rasa syukur yang mendalam dan merupakan salah satu doa yang dikabulkan langsung oleh Allah SWT saat membatalkan ibadah shaum.",
              style: TextStyle(
