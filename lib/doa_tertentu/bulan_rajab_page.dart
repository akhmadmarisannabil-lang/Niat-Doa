...
class BulanRajabPage extends StatelessWidget {
  const BulanRajabPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Allahumma baarik lana fii rajaba wa sya'baana wa ballighna ramadhaana.",
              style: TextStyle(
                color: subTextColor,
                fontSize: 14,
          ...
          Container(
            ...
            child: Text(
              "Doa yang dibaca berulang-ulang sejak awal bulan Rajab untuk memohon keberkahan umur, peningkatan amal, serta kesiapan jiwa menggapai bulan suci Ramadan.",
              style: TextStyle(
