...
class WaktuSahurPage extends StatelessWidget {
  const WaktuSahurPage({super.key});
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "Rabbanaghfir lana wa li-ikhwaninal-ladzina sabaquuna bil-iiman.",
              style: TextStyle(
                color: subTextColor,
                fontSize: 14,
          ...
          Container(
            ...
            child: Text(
              "Ya Tuhan kami, ampunilah kami dan saudara-saudara kami yang telah beriman lebih dulu sebelum kami.",
          ...
          Container(
            ...
            child: Text(
              "Dianjurkan memperbanyak istighfar dan memohon ampunan di sepertiga malam terakhir, yakni waktu utama menjelang terbitnya fajar (Subuh).",
              style: TextStyle(
