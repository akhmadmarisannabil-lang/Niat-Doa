...
class DzuhurPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(
        0xff090f16,
      ), // Latar belakang gelap bblue-dark
      appBar: AppBar(
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              "أُصَلِّىْ فَرْضَ الظُّهْرِ أَرْبَعَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ أَدَاءً لِلّٰهِ تَعَالَىٰ",
          ...
          Container(
            ...
            child: const Text(
              "Ushallii fardhaz-zhuhri arba'a raka'aatin mustaqbilal qiblati adaa'an lillaahi ta'aalaa.",
              style: TextStyle(
