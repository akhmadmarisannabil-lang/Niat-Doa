...
class SubuhPage extends StatelessWidget {
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              ...
              textAlign: TextAlign
                  .center, // Mengubah posisi teks ke rata tengah sesuai image_352847.png
              style: GoogleFonts.amiri(
                // Menggunakan font Amiri agar lekukan arabnya tipis dan anggun
                color: Colors.white.withOpacity(0.9),
                fontSize: 24,
                fontWeight:
                    FontWeight.normal, // Dibuat normal (tidak terlalu tebal)
                height: 2.2,
              ),
            ),
          ),
          ...
          Container(
            ...
            child: const Text(
              "Ushallii fardhas-subhi rak'ataini mustaqbilal qiblati adaa'an lillaahi ta'aalaa.",
              style: TextStyle(
